...
@testset "ParseISP.jl" begin
    ...
    include("test_input_preparation_2026.jl")
    include("test_buildout_defaults_documentation_2024.jl")
    include("test_source_specs_2024.jl")
    include("test_frozen_generator_order_2024.jl")
    include("test_source_specs_2026.jl")
    include("test_network_readers_2026.jl")
    include("test_generation_readers_2026.jl")
    include("test_reliability_readers_2026.jl")
    include("test_pipeline_integration_2024.jl")
    include("test_pipeline_regression_fixture_2024.jl")
    include("test_scenarios_2026.jl")
end

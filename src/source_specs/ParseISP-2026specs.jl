...
register_source_specs!(
    ...
    XlsxSourceSpec(
        ...
        cell_range = "B6:H30",
        description = "ISP 2026 network flow-path capability table.",
        columns = _isp2026_columns([
            "Flow path", "Forward peak (MW)", "Forward summer (MW)",
            "Forward winter (MW)", "Reverse peak (MW)", "Reverse summer (MW)",
            "Reverse winter (MW)",
        ]),
        source_family = :network,
    ),
    XlsxSourceSpec(
        ...
        cell_range = "B11:O127",
        description = "ISP 2026 flow-path augmentation options table.",
        columns = _isp2026_columns([
            "Flow path", "Option", "Power-flow direction", "Forward increase (MW)",
            "Reverse increase (MW)", "Indicative cost (\$2025 million)",
            "Easement (km)", "Lead time",
        ]),
        source_family = :network,
    ),
    XlsxSourceSpec(
